use crate::containers::anyref::inner::{AnyRefInner, MAX_REFCOUNT};
use crate::containers::anyref::ptr_interface::PtrInterface;
use crate::containers::anyref::strong::AnyRef;
...
impl WeakAnyRef {
    ...
    ///
    /// ```
    /// use castbox::containers::WeakAnyRef;
